                        ...
                        <div class="flex space-x-4 items-center">
                            <div class="w-1/2 flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input required name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Nombre" value="">
                                </div>
                            </div>
                            <div class="w-1/2 flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                        ...
                        <div class="flex space-x-4 items-center">
                            <div class="w-1/4 flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input required name="price" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                     id="name" type="number" step="0.01" placeholder="Ej: 200" value="">
                                </div>
                            </div>
                            <div class="w-1/4 flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                            ...
                            <div class="w-1/4 flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    id="color_main" type="color" placeholder="Ej: #200000" value="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex  space-x-5">
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        <input required name="image_main" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="img" type="file" placeholder="Imagen" value="">
                                    </div>
                                </div>
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        <input required name="image_second" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="img" type="file" placeholder="Imagen" value="">
                                    </div>
                                </div>
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        <input required name="image_background" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="img" type="file" placeholder="Imagen" value="">
                                    </div>
                                </div>
                            ...
                            <div class="flex  space-x-5">
                                <div class="w-1/2 flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        id="img" type="text" placeholder="Titulo" value="" required>
                                    </div>
                                </div>
                                ...
                                <div class="w-1/2 flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        id="img" type="text" placeholder="subtitulo" value="" required>
                                    </div>
                                </div>
                            </div>
                            <hr class="pb-5">
                                ...
                                <script>
                                    ...
                                    function printFeatureToList(){
                                        ...
                                        if(features.length > 0 ){
                                            features.forEach( f => {
                                                items += `<p>+ <span class="title font-bold">${f.title}</span> - <span class="subtitulo">${f.subtitle}</span> <span class="text-red-500 cursor-pointer" onclick="deleteFeature(${f.index})">x</span></p>`;
                                            });
